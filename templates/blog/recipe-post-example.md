...
> This file is a few-shot example for the blog_post_recipe.md prompt template.
> It demonstrates the expected structure, tone, and frontmatter format for
> standalone recipe blog posts (600-800 words).
...
It is genuinely 25 minutes, start to table. The key is slicing the chicken thin so it cooks fast, and having everything prepped before you heat the pan. One pan, one sauce, done.
...
> **This is one dinner. Want the other four nights handled too?** Slated builds a personalized weekly plan around your family's preferences -- and everyone gets to vote on it before you buy the groceries.
...
- Short intro (2-3 sentences, no long preamble)
- "Why this works" section before ingredients
- Standard ingredients and instructions format
- Mid-post CTA after instructions (inline, natural tone)
- Tips/substitutions section
- End-of-post BlogCTA component with pillar prop
- All frontmatter fields needed for Schema.org Recipe markup
- Total length: ~650 words (target 600-800)
