...
the dinner system -- and is happy to share. Not an expert lecturing from above.
Not a brand selling. A real person who gets the struggle and has a practical solution.
...
- Be specific: "25-Minute Chicken Stir Fry" > "Easy Dinner Recipe"
...
- Length: 250-500 characters (use the space)
- No hashtags (deprecated on Pinterest)
- No calls to action in the description (Pinterest penalizes engagement bait)

### Alt Text (500 chars max)
- Describe what is IN the image + include primary keyword
- Confirmed to improve impressions by ~25%

### Text Overlay on Pin Images
- 6-8 words maximum for headline
- Must be readable at ~300px thumbnail width
